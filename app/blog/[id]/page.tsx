    ...
    <article>
      ...
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        <div className={post.imageUrl ? "-mt-24 relative z-10" : "pt-16 sm:pt-24"}>
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 font-[var(--font-mono)] text-[10px] uppercase tracking-[3px] text-neutral-600 transition-colors hover:text-[var(--color-accent)]"
          >
          ...
          {/* Meta */}
          <div className="mt-8 flex items-center gap-3 font-[var(--font-mono)] text-[10px] uppercase tracking-[3px] text-neutral-600">
          ...
          {/* Title */}
          <h1 className="mt-6 font-[var(--font-serif)] text-4xl leading-[1.15] text-[var(--color-bone)] sm:text-5xl md:text-6xl">
            {post.title}
          </h1>
