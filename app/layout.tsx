      ...
      <body className="font-[var(--font-sans)]">
        <ThemeProvider>
          <AuthProvider>
            ...
            {/* Fixed bottom-right links */}
            <div className="fixed bottom-5 right-5 z-50 flex items-center gap-3">
              <a
                href="https://alextong.me/"
                target="_blank"
                rel="noopener noreferrer"
                className="block h-10 w-10 overflow-hidden rounded-full border border-[var(--color-border)] bg-[var(--color-surface-raised)] shadow-lg transition-transform hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-[var(--color-border)] bg-[var(--color-surface-raised)] shadow-lg transition-transform hover:scale-110"
                aria-label="GitHub"
              >
